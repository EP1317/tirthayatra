...
STORY_FILES: dict[str, list[str]] = {
    ...
    "krishna-yashoda-mother": ["Yashoda Krishna.jpg", "Baby Krishna.jpg", "Krishna.jpg"],
    ...
    "sita-as-rama-consort": ["Sita.jpg", "Rama with Sita and Lakshmana.jpg"],
    ...
    "brahma-saraswati-knowledge": ["Brahma.jpg", "Saraswati.jpg"],
    ...
    "ayyappa-foster-father-raja": ["Ayyappa.jpg"],
    "mangal-bhumi-family": ["Planet Mars.jpg", "Mangala.jpg"],
}
